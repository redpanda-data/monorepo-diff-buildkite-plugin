[![e2e status](https://badge.buildkite.com/719d0b895285367c9c57a09e07f1e853148d2509f0667e0ae8.svg?branch=master)](https://buildkite.com/redpanda-data/monorepo-diff-buildkite-plugin)
[![codecov](https://codecov.io/gh/redpanda-data/monorepo-diff-buildkite-plugin/branch/master/graph/badge.svg?token=DQ3B4FIYD2)](https://codecov.io/gh/redpanda-data/monorepo-diff-buildkite-plugin)
[![Publish](https://github.com/redpanda-data/monorepo-diff-buildkite-plugin/actions/workflows/publish.yml/badge.svg)](https://github.com/redpanda-data/monorepo-diff-buildkite-plugin/actions/workflows/publish.yml)
...
steps:
  - label: "Triggering pipelines"
    plugins:
      - redpanda-data/monorepo-diff#v2.5.8:
...
Please read [contributing guide](https://github.com/redpanda-data/monorepo-diff-buildkite-plugin/blob/master/CONTRIBUTING.md).
